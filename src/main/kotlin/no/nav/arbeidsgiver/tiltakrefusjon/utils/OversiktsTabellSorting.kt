...
fun sortPageable(sortingOrder: SortingOrder): Sort {
    val sort = when (sortingOrder) {
        ...
        SortingOrder.DELTAKER_ASC -> Sort.by(ASC, "refusjonsgrunnlag.tilskuddsgrunnlag.deltakerEtternavn", "refusjonsgrunnlag.tilskuddsgrunnlag.deltakerFornavn")
        SortingOrder.DELTAKER_DESC -> Sort.by(DESC, "refusjonsgrunnlag.tilskuddsgrunnlag.deltakerEtternavn", "refusjonsgrunnlag.tilskuddsgrunnlag.deltakerFornavn")
        SortingOrder.PERIODE_ASC -> Sort.by(ASC, "refusjonsgrunnlag.tilskuddsgrunnlag.tilskuddFom", "refusjonsgrunnlag.tilskuddsgrunnlag.tilskuddTom")
        SortingOrder.PERIODE_DESC -> Sort.by(DESC, "refusjonsgrunnlag.tilskuddsgrunnlag.tilskuddFom", "refusjonsgrunnlag.tilskuddsgrunnlag.tilskuddTom")
