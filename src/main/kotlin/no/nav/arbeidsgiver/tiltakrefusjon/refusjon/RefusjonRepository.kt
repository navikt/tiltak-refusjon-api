...
interface RefusjonRepository : JpaRepository<Refusjon, String> {
    ...
    fun findAllByFristForGodkjenningBeforeAndStatus(
    ...
    @Query(
        """
            ...
            where r.bedriftNr in (:bedriftNr) 
              and (:status is null or r.status = :status)
              and (:tiltakstype is null or r.refusjonsgrunnlag.tilskuddsgrunnlag.tiltakstype = :tiltakstype)
              and (:mentorToggle = true or r.refusjonsgrunnlag.tilskuddsgrunnlag.tiltakstype != 'MENTOR')
    ...
    fun findAllByBedriftNrAndStatusDefaultSort(
        ...
        @Param("mentorToggle") mentorToggle: Boolean = false,
        pageable: Pageable
    ): Page<Refusjon>
    ...
    fun findAllByStatusAndRefusjonsgrunnlagTilskuddsgrunnlagTiltakstypeIn(
        status: RefusjonStatus,
        tiltakstype: Collection<Tiltakstype>
    ): List<Refusjon>

    fun findAllByStatusAndRefusjonsgrunnlagTilskuddsgrunnlagTiltakstypeNotIn(
        status: RefusjonStatus,
        tiltakstype: Collection<Tiltakstype>
    ): List<Refusjon>

    fun findAllByRefusjonsgrunnlag_Tilskuddsgrunnlag_AvtaleNrAndStatusIn(
        avtaleNr: Int,
        status: List<RefusjonStatus>
    ): List<Refusjon>
