...
data class Refusjonsgrunnlag(
    ...
    fun hentBeregnetGrunnlag(): Int {
        return inntekter
                ...
                .filter { it.hentAntallOpptjenteDager(datoRefusjonstart, datoRefusjonslutt) > 0 }
                .map { inntekt ->
                    ...
                    total.div(inntekt.hentAntallOpptjenteDager(datoRefusjonstart, datoRefusjonslutt))
                }
                .sum()
